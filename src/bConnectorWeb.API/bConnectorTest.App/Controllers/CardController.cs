...
public class CardController : Controller
{
            ...
            {{
                ...
                ""actions"": [
                    {{
                        ...
                        ""target"": ""https://78a0-103-78-55-154.ngrok-free.app/api/dueDate2"",
  ...
  ""address"": ""{address}""
        ...
        string dbPostAPi = "https://afa1-103-78-55-154.ngrok-free.app/api/Contacts/add";
        ...
        using (var httpClient = new HttpClient())
        {
            ...
            {
                var response2 = await httpClient.PostAsync(dbPostAPi, content2);
